...
class AStarSearch:
    ...
    def expand(self, current_node, city_to_weight_map, city_to_cords, heuristic):
        nodes = []
        ...
        for neighbor in neighbors:
            ...
            action =  + heuristic(point_1 = city_to_cords[s_prime],
                                  point_2 = city_to_cords[current_node.get_state()])
            f_score = cost + action
    ...
    def astar_search(self, initial, goal, city_to_weight_map, city_to_coords, heuristic):
        ...
        while not self.frontier.empty():
            ...
            for child in self.expand(node, city_to_weight_map, city_to_coords, heuristic):
                s = child.get_state()
